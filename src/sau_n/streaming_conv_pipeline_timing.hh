...
class StreamingConvPipelineTiming : public ClockedObject
{
  ...
  private:
    struct StreamingStats : public statistics::Group
    {
        ...
        statistics::Scalar spadReadRequestsA;
        statistics::Scalar spadReadGrantsA;
        statistics::Scalar spadReadResponsesA;
        statistics::Scalar spadReadRequestsC;
        statistics::Scalar spadReadGrantsC;
        statistics::Scalar spadReadResponsesC;
        statistics::Scalar spadReadRequestsB;
        statistics::Scalar spadReadGrantsB;
        statistics::Scalar spadReadResponsesB;
        statistics::Scalar bBufferFillVectors;
        statistics::Scalar bBufferConsumedVectors;
        statistics::Scalar bBufferHitVectors;
        statistics::Scalar bBufferEmptyCycles;
        statistics::Scalar bBufferSwitches;
        statistics::Scalar bPrefetchStallCycles;
        statistics::Scalar weightReuseHits;
        statistics::Scalar spadWriteRequestsD;
        statistics::Scalar spadWriteGrantsD;
        statistics::Scalar dPendingPeak;
        statistics::Scalar dWriteStallCycles;
        statistics::Scalar bBufferAverageOccupancy;
        statistics::Scalar bBufferPeakOccupancy;
        statistics::Vector perBankReadCycles;
        statistics::Vector perBankWriteCycles;
        statistics::Vector perBankReadWriteConflicts;
    } stats;
