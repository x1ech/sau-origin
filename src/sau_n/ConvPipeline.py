...
class ConvPipelineTiming(ClockedObject):
    type = "ConvPipelineTiming"
    cxx_class = "gem5::sau_n::ConvPipelineTiming"
    cxx_header = "sau_n/conv_pipeline_timing.hh"
    ...
    trace_file = Param.String("", "Canonical pipeline cycle CSV path")
